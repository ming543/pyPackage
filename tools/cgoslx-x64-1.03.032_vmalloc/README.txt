...
The modified driver cgoslx-x64-1.03.030_vmalloc will only work for Kernels > 5.8
if you have a Kernel patched with cgos_vmalloc.patch. 
Please see README_VMALLOC.txt for build instructions.
