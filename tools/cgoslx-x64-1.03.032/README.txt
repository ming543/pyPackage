...
###############################################
##### ATTENTION WHEN USING KERNELS >= 5.8 #####
###############################################

Due to changes beginning with Kernel 5.8 accessing the CGOS interface will result in a NX page access violation.
You can use the Kernel boot parameter noexec=off but please be aware that this might be a security risk.
Please use an older Kernel until there is an update for this issue.
