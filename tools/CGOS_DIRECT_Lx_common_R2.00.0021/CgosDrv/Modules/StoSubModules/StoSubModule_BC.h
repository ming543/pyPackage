...
#ifndef _STOSUBMOD_BC_H_
#define _STOSUBMOD_BC_H_

extern unsigned int RegisterStoSubModule_BC(unsigned int (*RegisterSubModule)(	CgosFunctionPointer initSubModule,				    
