...
#ifndef _VGASUBMOD_BC_H_
#define _VGASUBMOD_BC_H_

extern unsigned int RegisterVgaSubModule_BC(unsigned int (*RegisterSubModule)(	CgosFunctionPointer initSubModule,				    
