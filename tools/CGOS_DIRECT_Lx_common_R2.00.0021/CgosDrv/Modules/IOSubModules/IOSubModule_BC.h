 ...
 *---------------------------------------------------------------------------
 */ 
#ifndef _IOSUBMOD_BC_H_
#define _IOSUBMOD_BC_H_
extern unsigned int RegisterIOSubModule_BC(unsigned int (*RegisterSubModule)(	CgosFunctionPointer initSubModule,
