...
#ifndef _BCSUBMOD_GEN5_H_
#define _BCSUBMOD_GEN5_H_

extern unsigned int RegisterBCSubModule_GEN5(unsigned int (*RegisterSubModule)(	CgosFunctionPointer initSubModule,
