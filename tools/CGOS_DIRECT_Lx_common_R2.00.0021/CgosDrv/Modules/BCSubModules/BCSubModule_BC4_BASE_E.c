...
//unsigned int initSubModule_BC4_BASE_E(CGOS_DRV_VARS *cdv);
unsigned int Probe_BC4_BASE_E(CGOS_DRV_VARS *cdv);
unsigned int bcCommand_BC4_BASE_E(unsigned char *cmdDataBPtr, unsigned char  cmdByteCount,
					   unsigned char *rcvDataBPtr, unsigned char  rcvByteCount,
					   unsigned char *retValueBPtr );
unsigned int CgosCgbcGetInfo_BC4_BASE_E(CGOS_DRV_VARS *cdv);
unsigned int CgosCgbcSetControl_BC4_BASE_E(CGOS_DRV_VARS *cdv);					
unsigned int CgosCgbcReadWrite_BC4_BASE_E(CGOS_DRV_VARS *cdv);
//unsigned int exitSubModule_BC4_BASE_E(CGOS_DRV_VARS *cdv);
					
//***************************************************************************

/***********************************************************************
 * unsigned int RegisterBCSubModule_BC4_BASE_E								
 * 																		
 ***********************************************************************
 ...
 * Modifications:														
 ***********************************************************************/
unsigned int RegisterBCSubModule_BC4_BASE_E(unsigned int (*RegisterSubModule)(	CgosFunctionPointer initSubModule,
								                    ...
								                    unsigned char Number)
{
	return RegisterSubModule(	NULL, //initSubModule
	                            Probe_BC4_BASE_E,
								bcCommand_BC4_BASE_E,
								CgosCgbcGetInfo_BC4_BASE_E,
								NULL, //CgosCgbcSetControl_BC4_BASE_E,
								NULL, //CgosCgbcReadWrite_BC4_BASE_E,
								NULL, //exitSubModule
								Number);
}
 ...
 * 																		
 ***********************************************************************
 * Description: This function can be used to see if BC4 Base E is
 *              present.		
 * 																		
...
unsigned int Probe_BC4_BASE_E(CGOS_DRV_VARS *cdv)
{
	...
	printk("CgosDrv: Probe_BC4_BASE_E called\n");
	...
	if(((rbuf[16] == 0x0E) && (rbuf[17] == 0x80)) || ((rbuf[18] == 0x0E)  && (rbuf[19] == 0x80)))
	{
		return CGOS_SUCCESS;
	}
...
/***********************************************************************
 * unsigned int bcCommand_BC4_BASE_E(unsigned char *cmdDataBPtr,					
