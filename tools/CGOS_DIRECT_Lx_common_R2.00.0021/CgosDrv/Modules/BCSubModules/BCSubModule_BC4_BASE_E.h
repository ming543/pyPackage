...
#ifndef _BCSUBMOD_BC4_BASE_E_H_
#define _BCSUBMOD_BC4_BASE_E_H_

extern unsigned int RegisterBCSubModule_BC4_BASE_E(unsigned int (*RegisterSubModule)(	CgosFunctionPointer initSubModule,
